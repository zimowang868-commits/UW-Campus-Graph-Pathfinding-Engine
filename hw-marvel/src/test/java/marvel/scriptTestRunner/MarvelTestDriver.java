...
public class MarvelTestDriver {
    ...
    private void findPath(String graphName, String start, String end) {
        ...
        Graph.Node<String> node2 = new Graph.Node<>(end);
        if (!graph.containsNode(node1) && !graph.containsNode(node2)) {
            ...
            List<Graph.Edge<String, String>> shortestPath = MarvelPaths.shortPath(graph, start, end);
            if (shortestPath.isEmpty() && !start.equals(end)) {
                output.println("no path found");
            }
            String res = start;
            for (Graph.Edge<String, String> edge : shortestPath) {
                output.println(res + " to " + edge.getDes().getNode() + " via " + edge.getLabel());
                res = edge.getDes().getNode();
            }
        }
    }
