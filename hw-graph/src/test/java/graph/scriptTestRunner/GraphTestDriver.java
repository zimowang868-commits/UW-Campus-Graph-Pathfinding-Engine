...
public class GraphTestDriver {
    ...
    private void addEdge(String graphName, String parentName, String childName,
                         String edgeLabel) {
        Graph<String, String> graph = graphs.get(graphName);
        graph.addEdge(new Graph.Node<>(parentName), new Graph.Node<>(childName), edgeLabel);
    ...
    private void listChildren(String graphName, String parentName) {
        ...
        for (Graph.Edge<String, String> edge : graph.getAllEdgesFrom(new Graph.Node<>(parentName))) {
            child.add(edge.getDes().getNode() + "(" + edge.getLabel() + ")");
        }
