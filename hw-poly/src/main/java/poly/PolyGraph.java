...
public final class PolyGraph extends Canvas {
    ...
    public void paint(Graphics g) {
        ...
        updatePlotBuffer(
                xMin, xMax, numIncrements, xValBuffer1, yValBuffer1, yExtrema, currentRatPoly);
     ...
     * @param xValBuffer the x value buffer
     * @param yValBuffer the y value buffer
     * @param yExtrema the y extrema
     * @param currentRatPoly the current RatPoly
     */
    public void updatePlotBuffer(float xMin, float xMax, int numIncrements, float xValBuffer[],
                                 float yValBuffer[], float yExtrema[], RatPoly currentRatPoly) {
     ...
     * Method to plot
     *
     * @param xMin the x max
     * @param xMax the x min
     * @param yMin the y min
     * @param yMax the y max
     * @param xValBuffer  the x val buffer
     * @param yValBuffer the y val buffer
     * @param gw width
     * @param gh height
     * @param bord who knows
     * @param numIncrements number of increments
     * @param h height
     * @param g the graphics
     */
    public void drawPlot(float xMin, float xMax, float yMin, float yMax, float xValBuffer[],
                         float yValBuffer[], float gw, float gh, int bord, int numIncrements, int h, Graphics g) {
        float xVal = 0;
        float yVal = 0;
        float previousX;
        float previousY;
