...
public final class RatNumTest {
    ...
    /**
     * Set of varied RatNums (includes NaNs) set is { 0, 1, -1, 2, 1/2, 3/2, 1/0, -1/0, 100/0 }.
     */
    ...
    /**
     * Set of varied NaNs set is { 1/0, -1/0, 100/0 }.
     */
    private RatNum[] ratNaNs = new RatNum[]{one_I_zero, negOne_I_zero, hundred_I_zero};

    /**
     * Set of varied non-NaN ratNums set is ratNums - ratNaNs.
     */
    ...
    // method beforehand. For example, suppose one of the test cases
    // for "negate" is:
    //
    ...
    //
    // In general, it is best to have as few dependencies in your test
    ...
    // asserts that two doubles are within .0000001 of one another.
    ...
    public void testDoubleValueNaN() {
        // To understand the use of "Double(Double.NaN)" instead of
        // "Double.NaN", see the Javadoc for Double.equals().
        assertEquals(Double.valueOf(Double.NaN), Double.valueOf(one_I_zero.doubleValue()));
    }
    ...
    public void testFloatValueNaN() {
        // To understand the use of "Float.valueOf(Float.NaN)" instead of
        // "Float.NaN", see the Javadoc for Float.equals().
        assertEquals(Float.valueOf(Float.NaN), Float.valueOf(one_I_zero.floatValue()));
    }
    ...
    private void decChk(String s, RatNum expected) {
        assertEquals(RatNum.valueOf(s), expected);
    }
    ...
    //
    // We test them in our best guess of increasing difficultly
    // and likelihood of having depend on a previous method.
    // For example, add could use sub as a subroutine.
    //
