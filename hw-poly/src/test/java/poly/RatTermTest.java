...
public final class RatTermTest {
    ...
    @Test
    public void testIsZeroFalsePos() {
        // Check for false positives
    ...
    public void testEvalNaN() {
        // To understand the use of "Double.valueOf(Double.NaN)" instead of
        // "Double.NaN", see the Javadoc for Double.equals().
        assertEquals(Double.valueOf(Double.NaN), Double.valueOf(term(3, 0, 2).eval(1.0)));
    }
    ...
    public void testHashCodeSameObject() {
        ...
        for(int i = 0; i < 25; i++) { // Verify Non random Hashcode
